...
public class Excel {
    public static boolean messhallReport(String filename, List<Report> reports){
        ...
        for(int  i=0; i<reports.size(); i++){
            ...
            row.createCell(2).setCellValue(MoneyConvert.keRupiah(Double.valueOf(reports.get(i).getTotal())));
